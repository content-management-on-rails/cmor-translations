...
module Cmor::Translations
  describe ImportTranslationsService do
    ...
    it { expect { ImportTranslationsService.call(translations: @translations) }.to change { Cmor::Translations::Translation.count }.from(0).to(12) }

    describe 'the new translation' do
      before(:each) do
        ImportTranslationsService.call(translations: @translations)
      end
      subject { Cmor::Translations::Translation.first }
